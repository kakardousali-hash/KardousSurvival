...
/*
   ...
   ولا تحتوي على castle_upgrade_end،
   نضيف العمود بدون حذف اللاعبين.
*/
...
function completeCastleUpgrade(
    player
) {
